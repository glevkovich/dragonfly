...
run_batch_mode() {
    ...
    set +e
    {
        ...
        for line in "${run_lines[@]}"; do
            ...
            echo ""
            echo "##########################################################################################"
            echo "# [${idx}/${#run_lines[@]}] ${line}"
            echo "##########################################################################################"
            if env BENCH_LOG_DIR="$outdir" "${parsed_envs[@]}" bash "$self" "${parsed_args[@]}"; then
        ...
        echo ""
        echo "========================================"
        echo " Batch complete: $(( ${#run_lines[@]} - failures ))/${#run_lines[@]} run(s) succeeded, ${failures} failed."
