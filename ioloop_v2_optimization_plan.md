...
| **15** | **[Idle-Flush Coalescing Delay (`pipeline_wait_batch_usec` for V2)](#task-15-idle-flush-coalescing-delay-pipeline_wait_batch_usec-for-v2--p2)** | **2** | **P2 — Experiment** | **Low** | **Trivial** | **Task 14 data** | — | **TODO** |
...
| **Task 15** | Idle-flush coalescing delay — port `pipeline_wait_batch_usec` to V2's idle-await path | Trivial | TODO (after Task 14 data) |
...
## Task 15: Idle-Flush Coalescing Delay (`pipeline_wait_batch_usec` for V2) — P2
