...
# Set RUN_MANIFEST_BENCHMARK=1 to time a 1,000-file fixture. The default suite
# validates a tar round-trip and rejects additions, deletions, content/size/mode
# changes, symlink changes, unsupported files, and manifest corruption.
...
expect_failure "unreadable regular file" 3 \
